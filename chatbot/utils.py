...
def get_conversational_chain(marks):
    ...
    prompt_template = f"""
    Answer the question as detailed as possible. Ensure to provide all relevant details, and if the answer is not available in the context, mention that it's unavailable. Avoid providing incorrect information.\n
    {detail_level}\n
    Context:\n {{context}}\n
    Question:\n {{question}}\n
    Answer:
...
def user_input(user_question,marks):
    embeddings = GoogleGenerativeAIEmbeddings(model="models/embedding-001")
